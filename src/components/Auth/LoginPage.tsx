        ...
        <div className="flex flex-wrap items-center">
            ...
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <Image
                  ...
                  src={"/images/logo/sarkaralogo-red.svg"}
                  alt="Logo"
                  width={176}
                  height={32}
                />
              ...
              <p className="2xl:px-20">
                Buat transaksi POS lebih mudah dengan Sarkara Back Office!
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Masuk / Login</span>
              ...
              <form>
                ...
                <div className="mb-5">
                  <button
                    className="mt-8 w-full cursor-pointer rounded-lg border border-primary bg-primary py-3 text-white transition hover:bg-opacity-90"
                    type="button"
                    // disabled={false}
