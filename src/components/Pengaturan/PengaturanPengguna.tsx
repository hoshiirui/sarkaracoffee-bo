...
const PengaturanPengguna = () => {
  ...
  const fetchData = () => {
    ...
    if (user) {
      ...
      setFormNama(JSON.parse(user).nama);
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (userData) {
        ...
        ToastError("Data pengguna tidak ditemukan!");
      }
    } catch (error) {
                  ...
                  <form action="#">
                          ...
                          <input
                            ...
                            onKeyDown={(e) => {
                              if (e.key == "Enter") {
                                ...
                                console.log("batal");
                                setFormNama(userData.nama);
                              }
                            }}
                            onBlur={() => setFormNama(userData.nama)}
                          />
                        </div>
                      </div>
                    ...
                    <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                      <div className="w-full sm:w-1/2">
                        ...
                        <input
                          className="w-full rounded border border-stroke bg-gray px-4.5 py-3 capitalize text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                          type="text"
                          name="role"
                          id="role"
                          disabled
                      ...
                      <div className="w-full sm:w-1/2">
                        ...
                        <input
                          ...
                          id="status"
                          disabled
                          defaultValue={userData.status ? "Aktif" : "Nonaktif"}
                        />
                      </div>
                    </div>
